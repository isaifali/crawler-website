...
function fetchUrls() {
  ...
  fetch('/fetch_urls', {
      ...
      .then(data => {
          ...
          var urlTableBody = document.getElementById('url-table-body');
          urlTable.style.display = 'inline-table';
          urlTableBody.innerHTML = '';

          data.urls.forEach((url, index) => {
              var row = urlTableBody.insertRow();
...
function clearDefaultText() {
  ...
  if (urlInput.value === "enter url here") {
      urlInput.value = "";
  }
}
...
document.getElementById('downloadBtn').addEventListener('click', function () {
        ...
        // Convert the HTML content to Blob
