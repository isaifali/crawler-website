...
# Dictionary to store cleanup schedules
cleanup_schedules = {}
...
def schedule_cleanup(pdf_path, word_path):
    ...
    del cleanup_schedules[word_filename]


def schedule_temporary_cleanup(file_path):
    # Wait for 5 minutes before cleanup
    time.sleep(300)
    ...
    if request.method == 'POST':
        ...
        if uploaded_files:
            ...
            if len(uploaded_files) == 1:
                ...
                # Schedule cleanup for temporary files after 5 minutes
                cleanup_thread = threading.Thread(target=schedule_temporary_cleanup, args=(image_path,))
                ...
                # Schedule cleanup for temporary files after 5 minutes
                cleanup_thread = threading.Thread(target=schedule_temporary_cleanup, args=(temp_dir,))
                cleanup_thread.start()
